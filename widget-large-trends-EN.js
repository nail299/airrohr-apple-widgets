...
async function createWidget() {
    ...
    try {
        ...
        let t24 = t24Stack.addText("24 hours");
        ...
        let t7 = t7Stack.addText("7 days");
        t7.font = Font.systemFont(10);
        t7.textColor = new Color("#94a3b8"); 

        w.addSpacer(8);

        addSensorRow(w, "Temperature", tempHist, new Color("#f59e0b")); 
        w.addSpacer(10);
        addSensorRow(w, "Humidity", humHist, new Color("#3b82f6")); 
        w.addSpacer(10);
        addSensorRow(w, "Pressure", pressHist, new Color("#22c55e"), true); 
        w.addSpacer(10);
        ...
        w.addSpacer();
        let errText = w.addText("Data Error. The openSenseMap server took too long to respond.");
